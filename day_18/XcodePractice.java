...
public class XcodePractice {
    public static void main(String[] args) {
        Scanner scan = new Scanner (System.in);
        System.out.println("Enter a Word");
        String word = scan.nextLine();
        //if(word.charAt(0)=='x')
        if(word.toLowerCase().startsWith("x")){ //or we can use toUppercase
        ...
        boolean loveCats = s1.toLowerCase().contains("cats"); // verifies if s1 HAS "cats"
    }
}
/*
